...
def main() -> int:
    ...
    path = ROOT / "data" / species.get("file", "pokemon_species.csv")
    min_rows = int(species.get("min_rows", 1))
    ...
    if count < min_rows:
        ...
        print(f"Run: python3 scripts/src/fetch_pokemon_catalog.py", file=sys.stderr)
        return 1
