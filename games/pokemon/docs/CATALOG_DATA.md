...
python3 scripts/src/validate_catalog.py

# Optional: official artwork URLs (slow)
python3 scripts/src/fetch_pokemon_catalog.py --fill-images

# Optional: flavor text (extra API call per row)
python3 scripts/src/fetch_pokemon_catalog.py --with-flavor
```
