  ...
  return (
    <div className="max-w-2xl mx-auto text-center py-16">
      ...
      <p className="text-gray-300 mb-6">
        Collection app in the same family as{' '}
        <a href="https://github.com/gardusig/yugioh" className="text-poke-gold underline" target="_blank" rel="noreferrer">
          yugioh
        </a>
        : browse a huge catalog, curate your active set, track progress.
      </p>
      <div className="grid sm:grid-cols-2 gap-4 max-w-md mx-auto text-left text-sm mb-8">
        <div className="p-4 rounded-lg border border-gray-700 bg-black/20">
          ...
          <div className="text-gray-400">≈ Yugioh Cards — paginated national dex</div>
        </div>
        <div className="p-4 rounded-lg border border-gray-700 bg-black/20">
          <div className="font-semibold text-poke-gold">Team</div>
          <div className="text-gray-400">≈ Yugioh Deck — 6 slots, Ash + Pikachu</div>
        </div>
      </div>
